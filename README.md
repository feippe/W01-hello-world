...
This simple software project prints the message "Hello World" to the console.  
...
I developed this software using **Visual Studio Code** as my IDE and **Git** for version control.  
The programming language I used is **Python**.  
I tested the program in a local terminal and uploaded the code to a public GitHub repository.
